...
\newpage
\subsection*{Tabelas Hash Distribuídas e o Kademlia}

%\todo[inline]{Explicar a funcionalidade de DHTs}
...
O Kademlia implementa uma rede \emph{overlay} cuja estrutura e comunicação se baseiam
...
\gls*{hashtable}. Durante uma busca, o algoritmo deve conhecer a chave (que é um
...
No Kademlia, objetos e nós possuem IDs únicos: o primeiro utiliza


Como o algoritmo Kademlia é construído com base em distâncias entre nós, a função de
medida escolhida foi
