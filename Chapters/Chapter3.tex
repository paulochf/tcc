...
O protocolo de troca de informações do Kademlia é formado por 4 comandos remotos:
\bverb|PING|, \bverb|STORE|, \bverb|FIND_NODE| e \bverb|FIND_VALUE|. O mais simples,
\bverb|PING|, verifica se o nó está online.

\todo[inline]{adicionar código do PING}
