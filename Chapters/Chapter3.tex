...
\glspl*{magnetlink}, não possuirá a chave \verb|info| em seu conteúdo, mas deverá
conter as chaves \verb|urn:btih:<hash>| e \verb|info_hash|.
...
possuirá o mesmo dicionário original, que contém a chave \verb|info_hash|, que é
...
\glspl*{peer} passam várias informações
