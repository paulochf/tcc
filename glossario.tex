...
\newglossaryentry{announce}{
    ...
    responde informando sobre a situação geral daquele \glink{torrent} e uma lista de
    outros \glsentryplural{peer} conectados naquele momento},
...
\newglossaryentry{kbucket}{
    name={$k$-bucket},
    description={\todo{escrever durante a revisão}},
...
\newglossaryentry{rpc}{
    ...
    é uma comunicação interprocessual de um programa de computador que permite a um
    processo executar procedimentos em outros endereços de rede ou de memória, sem a
    necessidade de conhecimento detalhadado do programador},
...
\newglossaryentry{endian}{
    ...
    \glsentryname{endian} é quando o bit mais significativo é guardado no menor
    ...
    first={\emph{\glsentryname{endian}} (significância do primeiro bit guardado)}
}
...
\newglossaryentry{overhead}{
    ...
    first={superconsumo de recursos (\glsentryname{overhead})}
}

\newglossaryentry{pgp}{
    name={PGP},
    description={\todo{acho q vai sair, né?}},
    long={\emph{Pretty Good Privacy}},
    first={algoritmo \glsentryname{pgp} (\glsentrylong{pgp})}
}
...
\newglossaryentry{socket}{
    ...
    de dados transmitidos pela rede para a camada de rede \todo[inline]{tentar usar
    socket de rede como first}},
