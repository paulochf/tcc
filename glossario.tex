...
% \textcolor{Bittersweet}{\ttfamily file} não é substituível por novo comando
\newglossaryentry{uri}{
    name={URI},
    ...
    \textcolor{Bittersweet}{\ttfamily file:///arquivo.txt} indica um arquivo computador
    local (nome de esquema \textcolor{Bittersweet}{\ttfamily file}), enquanto
    \textcolor{Bittersweet}{\ttfamily http://pagina.com} se refere a uma página de
    Internet (nome de esquema \textcolor{Bittersweet}{\ttfamily http})},
...
\newglossaryentry{caseinsensitive}{
    ...
    minúsculas); uma \glink{string} \glsentryname{caseinsensitive} não é diferenciada
    com letras iguais em caixas alta ou baixa. Assim,
    \textcolor{Bittersweet}{\ttfamily FOO}, \textcolor{Bittersweet}{\ttfamily Foo}
    e \textcolor{Bittersweet}{\ttfamily foo} seriam \glinkpl{string} dadas como iguais},
...
\newglossaryentry{querystring}{
    ...
    Internet, determinado por um caractere \textcolor{Bittersweet}{\ttfamily ?}. Por
    exemplo, em \textcolor{Bittersweet}{\ttfamily http://um/endereco/qualquer/?key1=value1\&key2=value2}},
...
\newglossaryentry{httpget}{
    ...
    first={método de requisição GET do protocolo HTTP},
    firstplural={métodos de requisição GET do protocolo HTTP}
}
...
\newglossaryentry{urn}{
    ...
    \textcolor{Bittersweet}{\ttfamily urn}. Sua sintaxe é
    \textcolor{Bittersweet}{\ttfamily urn:<NID>:<NSS>}, onde
    \textcolor{Bittersweet}{\ttfamily urn} é o prefixo \glink{caseinsensitive},
    \textcolor{Bittersweet}{\ttfamily <NID>} é o identificador de espaço de nomes, que
    determina a interpretação sintática de \textcolor{Bittersweet}{\ttfamily <NSS>},
