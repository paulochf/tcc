...
\newglossaryentry{peer}{
    name={peer},
    description={em português significa par, colega; como são chamados cada nó da rede
    desse tipo, ou seja, um computador conectado},
...
\newglossaryentry{gnutella}{
    ...
    lançado em 2000 sob a licença GPL. No dia seguinte, a AOL ordenou indisponibilizar
    o software alegando problemas legais e proibindo a continuação do desenvolvimento.
...
\newglossaryentry{swarming}{
    ...
    múltiplas fontes, é a transmissão coordenada de um arquivo a partir de
...
\newglossaryentry{seeder}{
    ...
    por estar conectado à rede, fornece partes a possíveis interessados},
