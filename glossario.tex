...
\newglossaryentry{bencode}{
    ...
    codificação de arquivos \glslink{torrent}{\glsentryname{torrent} para transmissão de
    \glslink{metadata}{\glsentryplural{metadata}. É chamado assim porque contém
    sequências de bytes ()},
