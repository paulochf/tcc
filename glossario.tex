...
\newglossaryentry{overhead}{
    name={\emph{overhead}},
    description={\todo{escrever}},
    first={sobrecarga de processamento (\glsentryname{overhead})}
}
...
\newglossaryentry{api}{
    name={API},
    description={Application Programming Interface (ou Interface de Programação de
    Aplicativos \todo{escrever}},
    first={\glsentryname{api}},
    plural={\glsentryname{api}s}
}

\newglossaryentry{xor}{
    name={XOR},
    description={\todo{escrever e revisar o uso}},
    first={\glsentryname{xor}}
}

\newglossaryentry{socket}{
    name={socket},
    description={portas de comunicação de dados dos programas, na camada de aplicação
    para a camada de rede \todo[inline]{explicar melhor, se possível}},
    first={\glsentryname{socket}},
