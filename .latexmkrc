...
$clean_ext = 'acn acr alg aux bbl bcf blg brf dvi fdb_latexmk fls glg glo gls idx ilg ind ist lof log lol lot maf mtc mtc1 out ps pyg run.xml synctex.gz synctex.gz(busy) tex.bak tdo toc xdy %R-blx.bib';
