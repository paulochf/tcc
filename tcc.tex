...
\includeonly{
    ...
    Chapters/Chapter4,     % 4. Parte técnica sobre componentes
    Chapters/Chapter5,     % 5. Conclusão
    Chapters/Chapter6,     % 6. Glossário
    Chapters/Chapter7,     % 7. Bibliografia
    Chapters/Chapter8      % 8. Parte Subjetiva
}
...
\newcommand{\xor}{\oplus}
\newcommand{\AND}{\wedge}
\newcommand{\Fexp}{$f_{exp}$\xspace}
\newcommand{\Fif}{$f_{if}$\xspace}
\newcommand{\Fxor}{$f_{xor}$\xspace}
\newcommand{\Fmaj}{$f_{maj}$\xspace}
...
\include{Chapters/Chapter7} % Bibliografia
